...
# ModInfo: moddump         Sample module showing standard format/tasks
# RUNLEVEL 9999 9999 
# CHECK check_moddump
# FIX fix_moddump
# UNDO undo_moddump
...
fix_trash()
{
  reportSubTaskStatus "SSH super stuff" "PASS"
  reportSubTaskStatus "SSH 1337 stuff" "FAIL" "red"
  reportSubTaskStatus "Tom is awesome" "Totally" "red"
}
#####################################################################
